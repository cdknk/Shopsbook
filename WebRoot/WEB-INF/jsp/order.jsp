			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
						...
						<p>
							选择付款方式（<span style=" color: red;">注：银行服务暂未开通,请选择其他下单方式</span>）：<br/>
						...
						<p>
							其他下单方式（<span style=" color: red;">注：此网站还未暂未正式上市，正在测试阶段，无法发货，请见谅！</span>）：<br/>
							<a href="index.jsp" style=" margin-left:80px;background-color: #ccc;padding: 20px;font-size: 15px;f"><b>货到付款</b></a>
						</p>
						<hr />
						<!--  
...
<div class="container footer">
	...
	<div class="span24">
		<div class="copyright">Copyright © 2017-2020 网上书城 版权所有</div>
	</div>
</div>
</body>
</html>