...
<html>
  <head>
    ...
    <title>My JSP 'ggb.jsp' starting page</title>
  ...
  <div id="adpic" style="width: 180px;height: 500px; border: 1px solid; float:left;position:fixed;top:10%;left:10px; ">
		<a href="http://ds.eywedu.com">
			<img src="${pageContext.request.contextPath}/image/aa.jpg" "/>
		</a>
		</div>
    <div id="adpics" style="width: 180px;height: 500px; border: 1px solid; float: right; position:fixed;top:10%;right: 10px; ">
		<a href="http://ds.eywedu.com">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/aa.jpg" style="display:none"/>
		</a>
		...
		<a href="http://www.xxbiquge.com/">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/cc.jpg" style="display:none"/>
		</a>
		<a href="http://tg360.37.com/?uid=1265098">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/dd.jpg" style="display:none"/>
		</a>
		<a href="http://www.zongheng.com/">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/ee.jpg" style="display:none"/>
		</a>
		<a href="http://game.zongheng.com/static/gamestart.html?source=dwby&zone=53">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/ff.jpg" style="display:none"/>
		</a>
		<a href="http://http://www.xxbiquge.com/">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/gg.jpg" style="display:none"/>
		</a>
		...
		<a href="https://www.jd.com/?cu=true&utm_source=haosou-search&utm_medium=cpc&utm_campaign=t_262767352_haosousearch&utm_term=4522341227_0_e1e8d4ee510749778330536fcc161713">
			<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/ii.jpg" style="display:none"/>
		</a>
	</div>
	<script language="JavaScript" type="text/javascript">
                    function runads()
                        {
                         var ads=document.getElementById("adpics").getElementsByTagName("img")
