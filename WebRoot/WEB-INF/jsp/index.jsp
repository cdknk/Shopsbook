...
<body>
	...
	<div class="container header">
		<div class="span5">
			<div class="logo">
				<a href="http://localhost:8080/shop/index.action"> 
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="网上书城" />
				 </a>
			</div>
		</div>
		<div class="span9">
			<div class="headerAd">
				<img src="${pageContext.request.contextPath}/image/header.jpg"
					width="420" height="60" alt="网上书城" title="网上书城" />
			</div>
		</div>
		<%@ include file="gg.jsp"%>
	...
	<div class="container index">
		...
		<div class="span24">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门书籍" title="热门书籍">
</div> -->
				<marquee direction="left">
				<h3 style="color: red;">热烈庆祝本书店开业，所有福利抽奖随机获取，祝大家合家欢乐，学富五车，祝各位老师桃李满天下，春晖遍四方，欢迎各位书友前来评头论足，感谢各位的光临！！！</h3>
				</marquee>
				<ul class="tabContent" style="display: block;">
					<s:iterator var="p" value="hList">
						<li><marquee direction="right" behavior="slide" > <a
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				<div class="title">
					<strong>最新书籍</strong> <a target="_blank"></a>
				</div>
				<ul class="tab">
				...
				<ul class="tabContent" style="display: block;">
					<s:iterator var="p" value="nList">
						<li><marquee direction="left" behavior="slide"> <a
								href="${ pageContext.request.contextPath }/product_findByPid.action?pid=<s:property value="#p.pid"/>"
								target="_blank"><img
								src="${pageContext.request.contextPath}/<s:property value="#p.image"/>"
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 2017-2020网上书城 版权所有</div>
		</div>
	</div>
</body>
</html>